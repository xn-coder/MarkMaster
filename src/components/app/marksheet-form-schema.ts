...
export const subjectEntrySchema = z.object({
  id: z.string().optional(), // Keep for useFieldArray key
  ...
  path: ['practicalMarksObtained'], // Or theoryMarksObtained, or a general path
});
// Removed refine for passMarks <= totalMarks as passMarks is removed
