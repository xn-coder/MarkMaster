  ...
  return (
    <div className="marksheet-print-container bg-gray-100 print:bg-white py-8 print:py-0 flex justify-center">
      <Card className="marksheet-card w-full max-w-[210mm] min-h-[297mm] mx-auto shadow-lg print:shadow-none border-4 border-black print:border-4 print:border-black my-4 print:my-0 print:mx-0 bg-white p-1 print:p-0.5 relative">
        ...
        <div className="border border-black print:border-black p-3 print:p-2.5 flex flex-col h-full relative z-10"> {/* Inner border and content wrapper */}
          ...
          <header className="relative mb-1 print:mb-0.5">
            ...
            <div className="flex flex-col items-center w-full mb-2 print:mb-1.5"> {/* Added margin-bottom */}
            ...
            <div className="text-center mt-1 print:mt-0.5 mb-3 print:mb-2"> {/* Added margin-bottom */}
              <div
          ...
          <h3 className="text-center font-bold text-lg print:text-base underline decoration-1 underline-offset-2 mb-3 print:mb-2 text-black">Student Details</h3>
          ...
          <div className="flex-grow flex flex-col"> {/* Ensure this wrapper allows flex-grow for table and pushes result/signature down */}
            <section className="mb-2 print:mb-1.5"> {/* Margin below table */}
                ...
                <Table className="border-collapse w-full">
                    ...
                    {compulsorySubjects.map((subject, index) => (
                        ...
                        <TableCell className="text-right border border-black p-1 print:p-0.5 text-black">{subject.passMarks}</TableCell>
                        <TableCell className="text-right border border-black p-1 print:p-0.5 text-black">{subject.theoryMarksObtained}</TableCell>
                        <TableCell className="text-right border border-black p-1 print:p-0.5 text-black">{subject.practicalMarksObtained}</TableCell>
                        <TableCell className="text-right border border-black p-1 print:p-0.5 font-bold text-black">{subject.obtainedTotal}</TableCell>
                        </TableRow>
                    ))}
            ...
            {/* Result and Place/Date - Moved here, directly below the table */}
          ...
          <div className="mt-auto pt-10 print:pt-8 text-xs print:text-[9px] text-black"> {/* Increased top padding */}
      ...
      <style jsx global>{`
        @media print {
          ...
          .marksheet-card {
            ...
            border-width: 4px !important; /* Outer border thickness */
            border-color: black !important;
            padding: 2pt !important; 
            margin: 0 !important; 
          }
          .marksheet-card > div:first-child { /* Inner content div */
             padding: 0.75rem !important; /* equivalent to p-3 */
          ...
          .print\\:border-4 { border-width: 4px !important; } /* Ensure outer border thickness */
          ...
          .print\\:text-sm { font-size: 10pt !important; line-height: 1.2 !important; } 
          .print\\:text-base { font-size: 11pt !important; line-height: 1.2 !important; } 
          .print\\:text-lg { font-size: 12pt !important; line-height: 1.2 !important; } 
