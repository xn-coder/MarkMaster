...
export function MarksheetDisplay({ data, onCreateNew, isViewMode = false }: MarksheetDisplayProps) {
  ...
  return (
    <div className="marksheet-print-container bg-gray-100 print:bg-white py-8 print:py-0 flex justify-center">
      <Card className="marksheet-card w-full max-w-[210mm] min-h-[297mm] mx-auto shadow-lg print:shadow-none border-2 border-black print:border-2 print:border-black my-4 print:my-0 print:mx-0 bg-white p-1 print:p-0.5 relative">
        {/* Watermark */}
        ...
        <div className="border border-black print:border-black p-3 print:p-2.5 flex flex-col h-full relative z-10"> {/* Inner border and content wrapper */}
            ...
            <section className="flex-grow flex flex-col mb-2 print:mb-1">
                ...
                <Table className="border-collapse w-full">
                    ...
                    {compulsorySubjects.map((subject, index) => (
                        <TableRow key={`comp-${index}`} className="border-b border-black h-[22px] print:h-[18px] hover:bg-transparent print:hover:bg-transparent dark:hover:bg-inherit text-xs print:text-[9pt]">
                    ...
                    {electiveSubjects.map((subject, index) => (
                        <TableRow key={`elec-${index}`} className="border-b border-black h-[22px] print:h-[18px] hover:bg-transparent print:hover:bg-transparent dark:hover:bg-inherit text-xs print:text-[9pt]">
                    ...
                    {additionalSubjects.map((subject, index) => (
                        <TableRow key={`add-${index}`} className="border-b border-black h-[22px] print:h-[18px] hover:bg-transparent print:hover:bg-transparent dark:hover:bg-inherit text-xs print:text-[9pt]">
          ...
          {/* Result and Signatures - pushed to bottom */}
      ...
      <style jsx global>{`
        @media print {
          body, html {
            height: 100%; /* Ensure html and body can provide a full height context */
            margin: 0 !important;
            padding: 0 !important;
          ...
          .marksheet-print-container {
             width: 100%;
             height: 100%;
             padding: 0 !important; /* Override screen py-8 */
             margin: 0 !important;
             display: flex !important;
             align-items: stretch !important; /* Stretch card to fill height */
             justify-content: stretch !important; /* Stretch card to fill width */
          }
          .marksheet-card {
            width: 100% !important;
            ...
            padding: 2pt !important; /* Outer padding for double border effect */
            margin: 0 !important; /* Remove screen margin */
          }
          .marksheet-card > div:first-child { /* Inner content div */
             padding: 0.625rem !important; /* equivalent to p-2.5 */
          ...
          .print\\:pt-2 { padding-top: 0.5rem !important; } /* Reduced from 1rem */
